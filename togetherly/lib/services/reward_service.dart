...
class RewardService {
  ...
  Future<List<Reward>> getChoresByFamily(int familyId) async {
  ...
  Future<void> updateChore(Reward reward) async {
    //Query by choreID
    await Supabase.instance.client
        .from(_rewardTable)
